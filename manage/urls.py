...
urlpatterns = patterns('',
                       ...
                       url('^suggestterms/(?P<admin_id>[\d\D]+)/operations/(?P<operation>[\d\D]+)',
                           views.SuggestView.as_view()),
                       url('^suggestterms/(?P<admin_id>[\d\D]+)/(?P<word>[\d\D]+)', views.SuggestView.as_view()),
                       url('^suggestterms/(?P<admin_id>[\d\D]+)', views.SuggestView.as_view()),
                       ...
                       url('^vip/adminIds$', views.VipAdminIdView.as_view()),
                       url('^vip/adminIds/operations/(?P<operation>[\d\D]+)$', views.VipAdminIdView.as_view()),
                       url('^vip/adminIds/(?P<admin_ids>[\d\D]+)$', views.VipAdminIdView.as_view()),
