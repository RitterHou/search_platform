...
urlpatterns = patterns('',
                       ...
                       url(
                           '^processes/operations/(?P<action>[\d\D]*)/host/(?P<host>[\d\D]*)/name/(?P<process>[\d\D]*)$',
                       ...
                       url('^yxd/suggestterms$', views.YxdSuggestView.as_view()),
                       ...
                       url('^vip/adminIds/operations/(?P<operation>[^/]+)$', views.VipAdminIdView.as_view()),
                       url('^vip/adminIds/(?P<admin_id>[^/]+)/operations/(?P<operation>[^/]+)$',
                           views.VipAdminIdView.as_view()),
                       url('^vip/adminIds/(?P<admin_ids>[^/]+)$', views.VipAdminIdView.as_view()),
                       url('^clusters/(?P<res_type>[^/]+)/operations/(?P<operation>[^/]+)$',
                           views.ClusterView.as_view()),
                       url('^clusters/(?P<res_type>[^/]+)/metrics/(?P<metrics>[^/]+)/(?P<admin_id>[^/]+)$',
                           views.ClusterView.as_view()),
